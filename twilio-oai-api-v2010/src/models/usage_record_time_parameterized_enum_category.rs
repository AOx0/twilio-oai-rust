...
pub enum UsageRecordTimeParameterizedEnumCategory {
...
impl std::fmt::Display for UsageRecordTimeParameterizedEnumCategory {
...
impl Default for UsageRecordTimeParameterizedEnumCategory {
    fn default() -> UsageRecordTimeParameterizedEnumCategory {
        Self::A2p10dlcRegistrationfeesBrandregistration
    }
}

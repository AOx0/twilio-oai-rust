...
pub enum FetchOutgoingCallerIdSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodOutgoingCallerId),
    UnknownValue(serde_json::Value),
}
...
pub enum ListOutgoingCallerIdSuccess {
    Status200(models::ListOutgoingCallerIdResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_outgoing_caller_id(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteOutgoingCallerIdSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn fetch_outgoing_caller_id(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchOutgoingCallerIdSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_outgoing_caller_id(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListOutgoingCallerIdSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_outgoing_caller_id(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<UpdateOutgoingCallerIdSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,

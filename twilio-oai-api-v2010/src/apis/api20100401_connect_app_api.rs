...
pub enum FetchConnectAppSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodConnectApp),
    UnknownValue(serde_json::Value),
}
...
pub enum ListConnectAppSuccess {
    Status200(models::ListConnectAppResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<DeleteConnectAppSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn fetch_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchConnectAppSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListConnectAppSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_connect_app(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<UpdateConnectAppSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,

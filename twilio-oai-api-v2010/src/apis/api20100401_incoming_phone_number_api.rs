...
pub enum CreateIncomingPhoneNumberSuccess {
    Status201(models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumber),
...
pub enum FetchIncomingPhoneNumberSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodIncomingPhoneNumber),
    UnknownValue(serde_json::Value),
}
...
pub enum ListIncomingPhoneNumberSuccess {
    Status200(models::ListIncomingPhoneNumberResponse),
    UnknownValue(serde_json::Value),
}
...
) -> Result<ResponseContent<CreateIncomingPhoneNumberSuccess>, Error<CreateIncomingPhoneNumberError>>
{
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateIncomingPhoneNumberSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
) -> Result<ResponseContent<DeleteIncomingPhoneNumberSuccess>, Error<DeleteIncomingPhoneNumberError>>
{
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<DeleteIncomingPhoneNumberSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
) -> Result<ResponseContent<FetchIncomingPhoneNumberSuccess>, Error<FetchIncomingPhoneNumberError>>
{
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchIncomingPhoneNumberSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_incoming_phone_number(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListIncomingPhoneNumberSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
) -> Result<ResponseContent<UpdateIncomingPhoneNumberSuccess>, Error<UpdateIncomingPhoneNumberError>>
{
    ...
    multipart_form_params.insert("AccountSid", params.account_sid);
    if let Some(param_value) = params.api_version {
        multipart_form_params.insert("ApiVersion", param_value.to_string());
    }
    if let Some(param_value) = params.friendly_name {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<UpdateIncomingPhoneNumberSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,

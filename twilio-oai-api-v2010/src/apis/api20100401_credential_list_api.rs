...
pub enum CreateSipCredentialListSuccess {
    Status201(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipCredentialList),
...
pub enum FetchSipCredentialListSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipCredentialList),
    UnknownValue(serde_json::Value),
}
...
pub enum ListSipCredentialListSuccess {
    Status200(models::ListSipCredentialListResponse),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_sip_credential_list(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateSipCredentialListSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn delete_sip_credential_list(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<DeleteSipCredentialListSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn fetch_sip_credential_list(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchSipCredentialListSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_sip_credential_list(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListSipCredentialListSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_sip_credential_list(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<UpdateSipCredentialListSuccess> = serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
            entity,

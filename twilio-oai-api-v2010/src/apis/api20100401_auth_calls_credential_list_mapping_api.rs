...
pub enum CreateSipAuthCallsCredentialListMappingSuccess {
    Status201(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsCredentialListMapping),
...
pub enum FetchSipAuthCallsCredentialListMappingSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsCredentialListMapping),
    UnknownValue(serde_json::Value),
}
...
pub enum ListSipAuthCallsCredentialListMappingSuccess {
    Status200(models::ListSipAuthCallsCredentialListMappingResponse),
    UnknownValue(serde_json::Value),
}
...
> {
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/Auth/Calls/CredentialListMappings.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), DomainSid=crate::apis::urlencode(params.domain_sid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateSipAuthCallsCredentialListMappingSuccess> =
...
> {
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/Auth/Calls/CredentialListMappings/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), DomainSid=crate::apis::urlencode(params.domain_sid), Sid=crate::apis::urlencode(params.sid));
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<DeleteSipAuthCallsCredentialListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchSipAuthCallsCredentialListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListSipAuthCallsCredentialListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,

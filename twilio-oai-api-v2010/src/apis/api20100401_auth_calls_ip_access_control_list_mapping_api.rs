...
pub enum CreateSipAuthCallsIpAccessControlListMappingSuccess {
    Status201(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsIpAccessControlListMapping),
...
pub enum FetchSipAuthCallsIpAccessControlListMappingSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthCallsPeriodSipAuthCallsIpAccessControlListMapping),
    UnknownValue(serde_json::Value),
}
...
pub enum ListSipAuthCallsIpAccessControlListMappingSuccess {
    Status200(models::ListSipAuthCallsIpAccessControlListMappingResponse),
    UnknownValue(serde_json::Value),
}
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateSipAuthCallsIpAccessControlListMappingSuccess> =
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<DeleteSipAuthCallsIpAccessControlListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchSipAuthCallsIpAccessControlListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListSipAuthCallsIpAccessControlListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,

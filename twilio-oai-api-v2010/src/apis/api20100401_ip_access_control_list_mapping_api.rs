...
pub enum CreateSipIpAccessControlListMappingSuccess {
    Status201(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipIpAccessControlListMapping),
...
pub enum FetchSipIpAccessControlListMappingSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipIpAccessControlListMapping),
    UnknownValue(serde_json::Value),
}
...
pub enum ListSipIpAccessControlListMappingSuccess {
    Status200(models::ListSipIpAccessControlListMappingResponse),
    UnknownValue(serde_json::Value),
}
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateSipIpAccessControlListMappingSuccess> =
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<DeleteSipIpAccessControlListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchSipIpAccessControlListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListSipIpAccessControlListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,

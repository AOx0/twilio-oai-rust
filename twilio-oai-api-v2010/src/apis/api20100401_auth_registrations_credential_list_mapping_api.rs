...
pub enum CreateSipAuthRegistrationsCredentialListMappingSuccess {
    Status201(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthRegistrationsPeriodSipAuthRegistrationsCredentialListMapping),
...
pub enum FetchSipAuthRegistrationsCredentialListMappingSuccess {
    Status200(models::ApiPeriodV2010PeriodAccountPeriodSipPeriodSipDomainPeriodSipAuthPeriodSipAuthRegistrationsPeriodSipAuthRegistrationsCredentialListMapping),
    UnknownValue(serde_json::Value),
}
...
pub enum ListSipAuthRegistrationsCredentialListMappingSuccess {
    Status200(models::ListSipAuthRegistrationsCredentialListMappingResponse),
    UnknownValue(serde_json::Value),
}
...
> {
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/Auth/Registrations/CredentialListMappings.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), DomainSid=crate::apis::urlencode(params.domain_sid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<CreateSipAuthRegistrationsCredentialListMappingSuccess> =
...
> {
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/SIP/Domains/{DomainSid}/Auth/Registrations/CredentialListMappings/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), DomainSid=crate::apis::urlencode(params.domain_sid), Sid=crate::apis::urlencode(params.sid));
    let mut req_builder = configuration
        .client
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<DeleteSipAuthRegistrationsCredentialListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<FetchSipAuthRegistrationsCredentialListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        let content = resp.text().await?;
        let entity: Option<ListSipAuthRegistrationsCredentialListMappingSuccess> =
            serde_json::from_str(&content).ok();
        Ok(ResponseContent {
            status,
            content,

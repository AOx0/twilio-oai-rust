...
pub struct AccountsPeriodV1PeriodAuthTokenPromotion {
...
impl AccountsPeriodV1PeriodAuthTokenPromotion {
    pub fn new() -> AccountsPeriodV1PeriodAuthTokenPromotion {
        AccountsPeriodV1PeriodAuthTokenPromotion {
            account_sid: None,
            auth_token: None,
            date_created: None,
            date_updated: None,

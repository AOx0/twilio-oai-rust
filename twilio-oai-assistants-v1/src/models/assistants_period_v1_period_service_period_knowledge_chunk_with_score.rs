...
pub struct AssistantsPeriodV1PeriodServicePeriodKnowledgeChunkWithScore {
    ...
    #[serde(rename = "knowledge_id", skip_serializing_if = "Option::is_none")]
    pub knowledge_id: Option<String>,
}

impl AssistantsPeriodV1PeriodServicePeriodKnowledgeChunkWithScore {
    pub fn new() -> AssistantsPeriodV1PeriodServicePeriodKnowledgeChunkWithScore {
        AssistantsPeriodV1PeriodServicePeriodKnowledgeChunkWithScore {
            account_sid: None,
            content: None,
            metadata: None,
            date_created: None,

...
pub struct AssistantsPeriodV1PeriodServicePeriodToolWithPolicies {
...
impl AssistantsPeriodV1PeriodServicePeriodToolWithPolicies {
    pub fn new(description: String, enabled: bool, id: String, meta: serde_json::Value, name: String, requires_auth: bool, r#type: String, date_created: String, date_updated: String) -> AssistantsPeriodV1PeriodServicePeriodToolWithPolicies {
        AssistantsPeriodV1PeriodServicePeriodToolWithPolicies {
            account_sid: None,
            description,
            enabled,
            id,
